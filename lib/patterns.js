...
var patternArray = exports.patternArray = [
  //typos
  {find: ".com0/", replace: ".com:80/"},
  {find: ":80//announce", replace: ":80/announce"},
  {find: ".com//announce", replace: ".com/announce"},
  //proper announce url
  {find: "ipv4.tracker.harry.lu", select: "udp://ipv4.tracker.harry.lu:80/announce"},
  {find: "tracker.istole.it:6969", select: "udp://tracker.istole.it:6969"},
  {find: "tracker.istole.it", select: "udp://tracker.istole.it:80"},
  {find: "open.demonii.com", select: "udp://open.demonii.com:1337/announce"},
  {find: "tracker.publicbt.com", select: "udp://tracker.publicbt.com:80"},
  {find: "tracker.openbittorrent.com", select: "udp://tracker.openbittorrent.com:80/announce"},
  {find: "exodus.desync.com", select: "udp://exodus.desync.com:6969/announce"},
  {find: "9.rarbg.me", select: "udp://9.rarbg.me:2710/announce"},
  {find: "9.rarbg.com", select: "udp://9.rarbg.com:2710/announce"},
  {find: "10.rarbg.me", select: "udp://10.rarbg.me:80/announce"},
  {find: "10.rarbg.com", select: "udp://10.rarbg.com:80/announce"},
  {find: "11.rarbg.me", select: "udp://11.rarbg.me:80/announce"},
  {find: "11.rarbg.com", select: "udp://11.rarbg.com:80/announce"},
  {find: "12.rarbg.", select: "udp://12.rarbg.me:80/announce"},
  {find: "inferno.demonoid.", select: "udp://inferno.demonoid.com:3389/announce"},
  {find: ".tntvillage.scambioetico.", select: "udp://tracker.tntvillage.scambioetico.org:2710/announce"},
  {find: "tracker.ex.ua", select: "udp://tracker.ex.ua:80/announce"},
  {find: "bt.rghost.net", select: "udp://bt.rghost.net:80/announce"},
  {find: "bt.rutor.org", select: "udp://bt.rutor.org:2710"},
  {find: "tracker.torrenty.org", select: "udp://tracker.torrenty.org:6969/announce"},
  {find: "tracker.token.ro", select: "udp://tracker.token.ro:80/announce"}
]

exports.apply = function (text) {
  for (var i in patternArray) {
    var index = text.indexOf(patternArray[i].find)
    if (index != -1) {
      if (typeof patternArray[i].replace !== "undefined") {
        text = text.replace(patternArray[i].find, patternArray[i].replace)
      } else if (typeof patternArray[i].select !== "undefined") {
        return patternArray[i].select
      }
    }
  }
...
exports.isValidAnnounceURL = function(url) {
  ...
  for (key in blacklist) {
    if (url.indexOf(blacklist[key]) != -1) {
      blacklisted = true
      break
    }
  }
